!function() {
    ...
    s.prototype.extend = function(t, e) {
        ...
        ,
        s.prototype.createEvent = function(t, e, n, i) {
            var o;
            return null == e && (e = !1),
            null == n && (n = !1),
            null == i && (i = null),
        ...
        ,
        s.prototype.removeEvent = function(t, e, n) {
        ...
        ,
        t = s,
        n = this.WeakMap || this.MozWeakMap || (l.prototype.get = function(t) {
            ...
            ,
            l),
        i = this.MutationObserver || this.WebkitMutationObserver || this.MozMutationObserver || (u.notSupported = !0,
        ...
        this.WOW = (h.prototype.defaults = {
            ...
            ,
            h.prototype.resetAnimation = function(t) {
                if (0 <= t.type.toLowerCase().indexOf("animationend"))
                    return (t = t.target || t.srcElement).className = t.className.replace(this.config.animateClass, "").trim()
            }
            ,
            h.prototype.customStyle = function(t, e, n, i, o) {
            ...
            h.prototype.vendorSet = function(o, t) {
                var s, r, l, e = [];
                for (s in t)
                    r = t[s],
                        o["" + s] = r,
